function pintarTareas(pListaTareas) {
    ...
    if (pListaTareas.length != 0) {
        ...
        for (tarea of pListaTareas) {
            ...
            listaTareas.innerHTML += '<div><p class= ' + colorPrioridad + ' >' + tarea.titulo + '</p><button name="delete" id=' + tarea.idTarea + '><i class="fas fa-trash"></i></button></div>';
        ...
        listaTareas.innerHTML = '<h2 class="sinTareas">No tienes nada</h2>';
    }
}
